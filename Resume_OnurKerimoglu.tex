...
%\cvaddress{Beltgens Garten 12\newline20537 Hamburg, Germany}
\cvlocation{Hamburg, Germany}
% phone number
...
% linkedIn
\cvlinkedin{https://linkedin.com/in/onur-kerimoglu}{linkedin.com/in/onur-kerimoglu}
% GitHub
\cvgithub{https://github.com/OnurKerimoglu}{github.com/OnurKerimoglu}
% pgp key
...
% 		\end{icontable}
    ...
    \sidesection{Technical Skills}
        ...
        \skill{\faChevronRight}{Programming Languages}
           \skill[2mm]{\faCaretRight}{\footnotesize Python, R, Bash, SQL, Fortran (2008), MATLAB}
        \skill{\faChevronRight}{Machine Learning} 
          \skill[2mm]{\faCaretRight}{\footnotesize \footnotesize SciPy, Scikit-learn, TensorFlow,  Keras, PyTorch, FastAI, OpenCV, Faiss, spaCy, LLMs}
          %\skill[4mm]{}{\footnotesize \footnotesize OpenCV, Faiss, spaCy\\}
        \skill{\faChevronRight}{Development \& MLOps}
           \skill[2mm]{\faCaretRight}{\footnotesize Git, FastAPI, Docker, GCP, Vertex AI}
        \skill{\faChevronRight}{Data Management and Processing}
          \skill[2mm]{\faCaretRight}{\footnotesize \footnotesize NumPy, Pandas, MySQL,  BigQuery}
    ...
    \pointskill{\faChevronRight}{Turkish}{5}
    \pointskill{\faChevronRight}{English}{5}
    \pointskill{\faChevronRight}{German}{4}
    \pointskill{\faChevronRight}{French}{2}
...
I am a data scientist with %expertise in prototyping and productionizing machine learning models. I have 
...
%Having published 30+ scientific publications and 90+ presentations, and 
...
\begin{cvtable}[1.0]
    ...
    \cvitem{10.2022 -- 02.2023}{Career Transition}
	{}
    {
...
% 	\textit{Responsibilities}:
	\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Papers:
      ...
      \href{https://doi.org/10.3389/fmars.2022.975414}{\color{pblue}{6}}, % Acevedo-Trejos et al 2022
      %\href{https://ospar.org/documents?v=48846}{\color{pblue}{8}}, % OSPAR report 2022
      \href{https://doi.org/10.1101/2022.05.18.492269}{\color{pblue}{7}}, % Kerimoglu et al BioRxiv
      \href{https://doi.org/10.1016/j.scitotenv.2022.158757}{\color{pblue}{8}}, % Tilstone et al 2023
      ...
      \href{https://doi.org/10.3389/fmars.2023.1129951}{\color{pblue}{11}} % Van Leuwen et al 2023
    \end{itemize}
...
\cvitem{05.2013 -- 09.2019}{Project Leader, Postdoctoral Researcher}
...
% 	\textit{Responsibilities}:
	\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
        \item Leading a project funded by \href{https://www.umweltbundesamt.de/en}{\color{pblue}{UBA}} on development and application of a 3-D physical-biogeochemical model %, and its application on the North Sea
        ...
        \item Papers::
            \href{https://doi.org/10.3389/fevo.2016.00131}{\color{pblue}{1}}, % Wirtz and Kerimoglu 2016
            \href{https://doi.org/10.5194/bg-14-4499-2017}{\color{pblue}{2}}, % Kerimoglu et al. 2017
            \href{https://doi.org/10.1016/j.ecolmodel.2017.07.008}{\color{pblue}{3}}, % Taherzadeh et al 2017
            \href{https://doi.org/10.5194/gmd-11-915-2018}{\color{pblue}{4}}, % Lemmen et al. 2018
            \href{https://doi.org/10.1016/j.ecss.2017.11.002}{\color{pblue}{5}}, % Nasermoaddeli et al 2017
            \href{https://doi.org/10.1007/s10750-018-3653-5}{\color{pblue}{6}}, % Slavik et al 2019
            \href{https://doi.org/10.1016/j.scitotenv.2018.05.215}{\color{pblue}{7}}, %Kerimoglu et al. 2018
            \href{https://doi.org/10.3389/fmars.2019.00370}{\color{pblue}{8}}, % van Beusekom et al. 2019
            \href{https://doi.org/10.1029/2019JC015987}{\color{pblue}{9}}, %Chegini et al 2020
            \href{https://doi.org/10.5194/bg-17-5097-2020}{\color{pblue}{10}}, %Kerimoglu et al 2020
            \href{https://doi.org/10.3389/fmars.2021.596126}{\color{pblue}{11}}, %Friedland et al. 2021
            \href{https://doi.org/10.3389/fmars.2021.637483}{\color{pblue}{12}} %Stegert et al. 2021
    \end{itemize}
%       \textit{Open-source software produced}:\\
...
% 	\textit{Responsibilities}:
	\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Papers:
      \href{https://doi.org/10.1111/fwb.12444}{\color{pblue}{1}}, % Jacquet et al. 2014
      \href{https://doi.org/10.1007/s10021-014-9837-6}{\color{pblue}{2}}, % Anneville et al. 2015
      \href{https://doi.org/10.1016/j.ecolmodel.2017.06.005}{\color{pblue}{3}}, % Kerimoglu et al. 2017
      \href{https://doi.org/10.1016/j.envsoft.2017.11.016}{\color{pblue}{4}} % Bruce et al. 2018
    \end{itemize}
    \end{changemargin}
    }       
...
% 	\textit{Responsibilities}:
	\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Papers:
      \href{https://doi.org/10.1002/2013WR013520}{\color{pblue}{1}} % Kerimoglu & Rinke 2012
    \end{itemize}
    \end{changemargin}  
    }
      
    \cvitem{05.2008 -- 10.2011}{Doctoral Researcher }
...
% 	\textit{Responsibilities}:
	\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Papers:
      \href{https://doi.org/10.1111/j.1365-2486.2009.02158.x}{\color{pblue}{1}}, %Straile et al. 2010
      \href{https://doi.org/10.1016/j.jtbi.2012.01.044}{\color{pblue}{2}}, % Kerimoglu et al. 2012
      \href{https://doi.org/10.1007/s12080-012-0164-2}{\color{pblue}{3}}, % Peeters et al. 2013
      \href{https://doi.org/10.1111/j.1600-0706.2012.20603.x}{\color{pblue}{4}}, % Kerimoglu et al. 2013
      \href{https://doi.org/10.1007/s10750-013-1551-4}{\color{pblue}{5}}, % Kerimoglu et al. 2014 
      \href{https://doi.org/10.1890/14-0839.1}{\color{pblue}{6}} % Straile et al. 2015
    \end{itemize}
    \end{changemargin}  
    }
      
    \cvitem{07.2006 -- 12.2007}{MSc Research Scholar}
...
\begin{cvtable}[1.0]
	...
	\cvitem{09.2006 -- 02.2008}{MSc, Biology}{\href{https://www.metu.edu.tr}{\color{pblue}{METU, Turkey}}}
    ...
    \cvitem{09.2000 -- 06.2005}{BSc, Environmental Engineering}{\href{https://www.metu.edu.tr}{\color{pblue}{METU, Turkey}}}
