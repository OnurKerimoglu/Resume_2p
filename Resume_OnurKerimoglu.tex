...
\addtofrontsidebar{
    ...
    \sidesection{Technical Skills}
        ...
        \skill{\faChevronRight}{Software Engineering}
           \skill[2mm]{\faCaretRight}{\footnotesize Git, Python VE's, Docker}
...
\begin{cvtable}[1.0]
    ...
    \href{https://onurkerimoglu-accindex-main-n021i3.streamlit.app/}{\color{pblue}{AccIndex}} (web app): accident frequency along the shortest route between two given addresses in Berlin (in progress, next step: using a GNN, predict based on the past accident data and other features like population density, area use, etc).\\
