...
\begin{cvtable}[1.0]
    ...
    \begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Prototyping and deploying ML models, writing blogposts
    \end{itemize}
    \textit{Tech stack:} SQL, Python Pandas, SciPy, Scikit-learn, TensorFlow, Keras, Docker\\
    \textit{Open-source software and blogposts}:\\
    \href{https://huggingface.co/spaces/OnurKerimoglu/facemoods}{\color{pblue}{FaceMoods}}: predicting emotions on human faces detected in images using an object detection model chained to a fine-tuned image classification model \\ %using an OpenCV face-detection model chained to a pretrained image classification model fine-tuned with Keras \& TensorFlow.\\
    ...
    \begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     \setlength\itemsep{1mm}
     \item Prototyping and deploying ML models %in solitude and teams
    \end{itemize}
