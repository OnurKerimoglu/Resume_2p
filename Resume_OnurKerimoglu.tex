...
\addtofrontsidebar{
    ...
    \sidesection{Technical Skills}
        ...
        \skill{\faChevronRight}{Development \& MLOps}
           \skill[2mm]{\faCaretRight}{\footnotesize Git, Shell scripting, Streamlit, Docker, AWS}
...
%\skill{\faChevronRight}{Maths}
%\skill[2mm]{\faCaretRight}{\footnotesize diff. calculus, linear algebra, statistics}
\cvsection{Example Personal Projects}
\href{https://huggingface.co/spaces/OnurKerimoglu/facemoods}{\color{pblue}{FaceMoods}}: predicting emotions in uploaded face images, using an image classification model built with Keras \& TensorFlow.\\
\vskip -1em
...
\vskip -1em
\href{https://medium.com/@kerimoglu.o/setting-up-a-mysql-environment-using-docker-on-linux-51e284d4c2b8}{\color{pblue}{On MySQL \& Docker}} A blogpost on installing and setting up a MySQL development environment using Docker on Linux.

\cvsection{Work Experience}
\begin{cvtable}[1.0]
    
    \cvitem{09.2022 -- 12.2022}{Data Scientist}
	...
	\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Development, implementation and rigorous testing of a physiological model of phytoplankton.%, in collaboration with colleageus in JSPS (Japan), GEOMAR (Germany) and Uni. Liverpool (UK) \item Extension of a model for simulating a lab experiment on microorganismal growth, coagulation/flocculation and nutrient recycling processes  % in collaboration with colleagues in ICBM 
    ...
    \end{itemize}
      ...
      \href{https://doi.org/10.1111/ele.13680}{\color{pblue}{2}},  %Ryabov et al
      \href{https://doi.org/10.5194/gmd-14-6025-2021}{\color{pblue}{3}}, %Kerimoglu et al 2021
      \href{https://doi.org/10.3389/fmars.2021.675428}{\color{pblue}{4}}, %Anugerahanti et al
      \href{https://doi.org/10.1002/lno.12005}{\color{pblue}{5}}, %Hillebrand et al 
      \href{https://doi.org/10.3389/fmars.2022.975414}{\color{pblue}{6}}, %Acevedo-Trejos et al
      \href{https://doi.org/10.1016/j.scitotenv.2022.158757}{\color{pblue}{7}}, %Tilstone et al
      \href{https://ospar.org/documents?v=48846}{\color{pblue}{8}}, %OSPAR report
      \href{https://doi.org/10.5194/gmd-16-95-2023}{\color{pblue}{9}}, %Kerimoglu et al 2023
      \href{https://doi.org/10.1101/2022.05.18.492269}{\color{pblue}{10}} %Kerimogul et al BioRxiv
    }
