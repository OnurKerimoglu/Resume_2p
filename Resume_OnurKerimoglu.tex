...
\begin{cvtable}[1.0]
    ...
    \begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Developing NLP-based solutions to text normalization and matching problems
     \item Overseeing the daily tasks of a team of 7 data scientists, data \& ML engineers
     \item Planning sprints, leading scrum meetings
     \item Contribute to definition of OKRs and managing the backlog accordingly
