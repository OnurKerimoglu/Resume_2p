...
% personal website
\cvsite{sites.google.com/view/onur-kerimoglu}
% pgp key
...
\addtofrontsidebar{
    ...
    \sidesection{Technical Skills}
        ...
        \skill{\faChevronRight}{Programming}
           \skill[2mm]{\faCaretRight}{\footnotesize Python, R, Fortran (2008)}
        \skill{\faChevronRight}{Software Engineering}
           \skill[2mm]{\faCaretRight}{\footnotesize git, Python VE's, Docker, Kubernetes}
        \skill{\faChevronRight}{Data Management and Processing}
          \skill[2mm]{\faCaretRight}{\footnotesize \footnotesize SQL, NumPy, Pandas}
        ...
        \skill{\faChevronRight}{Data Visualization and Reporting}
          \skill[2mm]{\faCaretRight}{\footnotesize HTML, CSS, D3, Plotly, Dash, \LaTeX} 
...
\begin{cvtable}[1.0]
    ...
    \cvitem{09.2022 -- Present}{Data Scientist}
    ...
    \end{itemize}
    Tech Stack: SQL, Python Pandas, SciPy, Scikit-learn, TensorFlow, Keras, PyTorch, Docker\\
    Example projects:\\
	...
	\begin{itemize}[leftmargin=*]
     ...
     \item Mathematical development, computer implementation and rigorous testing of a physiological model of phytoplankton, co-supervision of a postdoctoral scientist on the topic.%, in collaboration with colleageus in JSPS (Japan), GEOMAR (Germany) and Uni. Liverpool (UK)
     \item Extension of a model for simulating a lab experiment on microorganismal growth, coagulation/flocculation and nutrient recycling processes  % in collaboration with colleagues in ICBM 
    ...
    \end{itemize}
      Tech Stack: Python, R, Fortran, git, \LaTeX, Linux, HPC system\\  
    ...
    \end{itemize}
      Tech Stack: Python, Fortran, git, \LaTeX, Linux, HPC system\\
      Open-source software produced:\\
...
\cvsection{}
\cvsubsection{Working Experience (continued)}
\begin{cvtable}
\cvitem{05.2013 -- 06.2018}{Postdoctoral Researcher}
    ...
    \end{itemize}
      Tech Stack: Python, Fortran, git, GitHub, \LaTeX \\
    ...
    \end{itemize}
      Tech Stack: MATLAB, Windows Batch, MS Office; 
      Papers:
	...
	\begin{itemize}[leftmargin=*]
     ...
     \end{itemize}
     Tech Stack: MATLAB, MS Office, \LaTeX \\
     }
\end{cvtable}

\cvsection{Education and Training}
\begin{cvtable}[1.5]
	\cvitem{09.2022 -- Present}{Data Science Bootcamp}{\href{https://datascienceretreat.com}{\color{pblue}{Data Science Retreat, Germany}}}
		{Lectures and hands-on projects on various subjects and a 3-week final project on development and deployment of ML models, with an emphasis on NN models in the context of NLP, computer vision and image processing.}
	\cvitem{05.2008 -- 10.2011}{PhD, Theoretical Ecology}{\href{https://www.uni-konstanz.de/}{\color{pblue}{Uni. Konstanz, Germany}}}
		{\href{https://kops.uni-konstanz.de/bitstream/handle/123456789/16454/Kerimoglu_2011_PhD_Dissertation.pdf?isAllowed=y&sequence=1}{\color{pblue}{Thesis}} on development of a 1-Dimensional coupled physical-biological model for the simulation of Lake Constance ecosystem and theoretical analysis of phytoplankton competition in 
		heterogeneous environments.
		}
	\cvitem{09.2005 -- 02.2008}{MSc, Biology}{\href{https://www.metu.edu.tr}{\color{pblue}{METU, Turkey}}}
		{\href{http://etd.lib.metu.edu.tr/upload/12609272/index.pdf}{\color{pblue}{Thesis}} on multivariate statistical analysis of the relationships between large-scale atmospheric patterns and lake ecosystems. Grad courses including statistical learning, time series analysis, CFD, transport phenomena.}
