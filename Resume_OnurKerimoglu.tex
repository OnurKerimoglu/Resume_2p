...
\begin{cvtable}[1.0]
	...
	\begin{itemize}[topsep=0pt,itemsep=0pt,partopsep=0pt, parsep=0pt, leftmargin=*]
     ...
     \item Development, implementation and rigorous testing of a physiological model of phytoplankton, co-supervision of a postdoctoral scientist.%, in collaboration with colleageus in JSPS (Japan), GEOMAR (Germany) and Uni. Liverpool (UK) \item Extension of a model for simulating a lab experiment on microorganismal growth, coagulation/flocculation and nutrient recycling processes  % in collaboration with colleagues in ICBM 
