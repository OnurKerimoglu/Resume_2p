...
\begin{cvtable}[1.5]
	\cvitem{09.2022 -- 12.2022}{Data Science Bootcamp}{\href{https://datascienceretreat.com}{\color{pblue}{Data Science Retreat, Germany}}}
...
\begin{cvtable}[1.5]
	...
	\small{\begin{itemize}[leftmargin=*]
     ...
     \item Mathematical development, computer implementation and conceptual testing of a physiological model of phytoplankton, co-supervision of a postdocotoral scientist on the topic.%, in collaboration with colleageus in JSPS (Japan), GEOMAR (Germany) and Uni. Liverpool (UK)
...
%     \cvitem{MM.YYYY -- MM.YYYY}{Project Leader}
% 	{where}
% 	{Tasks:
% 	\small{\begin{itemize}[leftmargin=*]
%      \item?
%     \end{itemize}}
%       Tech Stack: Python, Fortran-2008, git, GitHub, \LaTeX \\
%       Open-source software produced: 
%       \\
%       Papers:
%       \href{?}{\color{pblue}{?}}
...
%         {}
%         {\small{\begin{itemize}
%         \item Intensive training on development and deployment of machine learning models
%         \item Technologies covered: Trees, time series, unsupervised learning, backpropagation \& deep learning, reinforcement learning, NLP, image processing, computer vision, graph neural networks, model deployment with Docker
%         %\item Techstack: Python Scikit-learn, TensorFlow, PyTorch, git, Docker, Kubernetes
%         \item Results:
%         \begin{itemize}
%          \item Predicting disease spread using Decision Tree, Random Forest, XG Boost, XGB Random Forest, and Gradient Boosting Regressors:
%         \end{itemize}
%         \end{itemize}}
%         }
%         \\   
...
%         \item Application of the model to the North Sea, compilation of a multi-component observation dataset, and evaluating model skill
...
%         \item Performing a scenario analysis with the model
%     \end{itemize}}
%     	}
%     \\
%     \twentyitemm
...
% 		{Oct 2011}
%         {Project scientist}
%         {\href{https://www.uni-konstanz.de/en/}{\color{pblue}{Uni. Konstanz, Germany}}}
%         {}
%         {\small{\begin{itemize}
%         \item Model-based analysis of phytoplankton growth in a lake
